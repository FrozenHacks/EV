...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val synd : Marker = mMap.addMarker(MarkerOptions().position(sydney).title("Marker in Sydney"))
        val chen : Marker = mMap.addMarker(MarkerOptions().position(chennai).title("Marker in Chennai"))
